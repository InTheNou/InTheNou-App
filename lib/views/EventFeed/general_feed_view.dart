...
class GeneralFeedState extends State<GeneralFeedView>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title: _eventFeedStore.isSearching(FeedType.GeneralFeed) ?
            _buildSearchField() : Text(feedTypeString(FeedType.GeneralFeed)),
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            Event _event = _eventFeedStore.feedEvent(FeedType.GeneralFeed, index);
            return Card(
